...
describe('Auth UseCase', () => {
  ...
  test('Should call LoadedUserByEmailRepository with correct email', async () => {
    const { sut, loadUserByEmailRepositorySpy } = makeSut()
    await sut.auth('any_email@mail.com', 'any_password')
    expect(loadUserByEmailRepositorySpy.email).toBe('any_email@mail.com')
  })

  test('Should throw null if am invalid email is provided', async () => {
    const { sut, loadUserByEmailRepositorySpy } = makeSut()
  ...
  test('Should throw null if am invalid password is provided', async () => {
  ...
  test('Should throw if no or invalid dependencies are provided', async () => {
    const invalid = {}
